...
# RTF_DEF, 20170519-weichen-B#11172, display source routing of VoIP WAN (ip route table 12) and VoD WAN (ip route table 11)
echo "###### ip rule list ######"
ip rule list
echo "###### ip route list table 12 ######"
ip route list table 12
echo "###### ip route list table 11 ######"
...
#RTF_DEF, 20211015-weichen-B#24566,[TEFSPHGU-323],Display the log in /var/swdStartChk
if [ -e /var/swdStartChk ]; then
    echo "=============== cat /var/swdStartChk ==============="
    cat /var/swdStartChk
fi
