...
#generate a random number to psp for wifi BSSID
pspctl dump wifiWPAKeyN
if [ $? == 255 ]
then
 random_mac
fi
...
# B#15491-[TEFBRHGU-181]
echo "Lan eth ports are disabled"
ethctl eth0 reg 0 0x1940
ethctl eth1 reg 0 0x1940
ethctl eth2 reg 0 0x1940
ethctl eth3 reg 0 0x1940
